...
class Sport extends Car {
  constructor(sportInfo = {}) {
    ...
    this.model = sportInfo.model;
    this.trim = sportInfo.trim;
    this.transmission = sportInfo.transmission;
    this.top = sportInfo.top;
    this.color = sportInfo.color;
    this.seatstrim = sportInfo.seatstrim;
    this.audio = sportInfo.audio;
    this.wheelstrim = sportInfo.wheelstrim;
    this.doors = 2;
    this.enginetype = sportInfo.enginetype;
    this.moonroof = false;
  }
}
...
let miataRf = new Sport({
  ...
  audio: 'premium',
  wheelstrim: 'premium',
  warranty: '100,000 miles / 5 years'
});
...
let trailBlazer = new Truck ({
  ...
  navigation: true,
  doors: 2,
  warranty: '150,000 miles / 6 years'
})
